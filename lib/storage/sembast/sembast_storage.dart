...
abstract class SembastStorage<T> extends EntityStorageAsync<int, T> {
  final Database database;
  final StoreRef<int, Map<String, Object?>> store;

  SembastStorage({required this.database, required String name})
  ...
  Future<Map<String, dynamic>> _updateOrCreate(T entity) async {
    ...
    if (id is int) {
      ...
      await store.record(id).update(database, {idName: id});
    }
