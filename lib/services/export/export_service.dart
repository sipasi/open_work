...
class ExportService<T> {
  ...
  Future exportToDownloads(
      T data, String name, ExportFormat format, FormatOptions options) {
    return exportTo(FolderLocation.downloads, data, name, format, options);
  }

  Future exportTo(FolderLocation location, T data, String name,
      ExportFormat format, FormatOptions options) async {
  ...
  Future<String> toFullPath(
      FolderLocation location, String name, ExportFormat format) async {
