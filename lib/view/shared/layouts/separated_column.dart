...
class SeparatedColumn extends StatelessWidget {
  ...
  static List<Widget> _separate(
    ...
    _tryAdd(result, firstSeparator, context, 0);
    ...
    _tryAdd(result, lastSeparator, context, result.length);
  ...
  static void _tryAdd(
    ...
    if (separator is IndexedWidgetBuilder) {
      widgets.add(separator(context, index));
    }
  }
}
